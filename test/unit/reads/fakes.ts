...
export class FakeGateway implements YouTrackGateway {
  ...
  public getProjectTeam(query: ProjectTeamQuery): Promise<ProjectTeamSnapshot> { return Promise.resolve({ project: query.project, users: [{ ...USER_A, membership: "direct", roles: [] }], groups: [], usersPage: { skip: query.page.skip, requestedTop: query.page.top, returned: 1, hasMore: false }, groupsPage: { skip: query.page.skip, requestedTop: query.page.top, returned: 0, hasMore: false }, teamRoles: [], rolesAvailable: true, warnings: [], source: "youtrack_project_team", completeness: { users: { status: "complete", reason: "authoritative_source_exhausted" }, groups: { status: "complete", reason: "authoritative_source_exhausted" }, directMembership: { status: "complete", reason: "authoritative_source_exhausted" }, roles: { status: "complete", reason: "authoritative_source_exhausted" } } }); }
